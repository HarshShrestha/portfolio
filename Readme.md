...
**Session 2 is the fun one** — when it finishes P2, open `/dev` and watch every animation before letting it build real sections. If any effect feels cheap, say so *there*, while it's still just primitives.
